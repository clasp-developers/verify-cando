...
(COMMON-LISP:DEFPARAMETER FEP::*SIDE-NAME* :LIGAND)
...
(COMMON-LISP:IF (COMMON-LISP:EQ FEP::*SIDE-NAME* ':LIGANDS)
                (COMMON-LISP:DEFPARAMETER FEP::*SYSTEM*
                  (CHEM:MATTER-COPY FEP::*LIGANDS*))
                (COMMON-LISP:DEFPARAMETER FEP::*SYSTEM*
...
(CANDO:SAVE-MOL2 FEP::*SYSTEM* (COMMON-LISP:ENSURE-DIRECTORIES-EXIST "AA-AB/ligand/ligand-vdw-bonded.mol2"))
(COMMON-LISP:ENSURE-DIRECTORIES-EXIST #P"AA-AB/ligand/ligand-vdw-bonded.parm7")
(COMMON-LISP:ENSURE-DIRECTORIES-EXIST #P"AA-AB/ligand/ligand-vdw-bonded.rst7")
(LEAP.TOPOLOGY:SAVE-AMBER-PARM-FORMAT FEP::*SYSTEM*
                                      "AA-AB/ligand/ligand-vdw-bonded.parm7"
                                      "AA-AB/ligand/ligand-vdw-bonded.rst7")
(CORE:EXIT)
