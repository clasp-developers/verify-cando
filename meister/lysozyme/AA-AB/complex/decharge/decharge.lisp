...
(COMMON-LISP:DEFPARAMETER FEP::LSOURCE (CANDO:LOAD-MOL2 "AA-AB/complex/source.mol2"))
...
(CANDO:SAVE-MOL2 FEP::DECHARGE "AA-AB/complex/decharge/decharge.mol2")
(LEAP.TOPOLOGY:SAVE-AMBER-PARM-FORMAT FEP::DECHARGE
                                      "AA-AB/complex/decharge/decharge.parm7"
                                      "AA-AB/complex/decharge/decharge.rst7")
(CORE:EXIT)
