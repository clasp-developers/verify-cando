...
(COMMON-LISP:LET ((FEP::TOTAL 0.0))
  (COMMON-LISP:LOOP FEP::FOR
                    FEP::FILENAME
                    FEP::IN
                    (list "AA-AB/complex/decharge/dvdl.dat" "AA-AB/complex/vdw-bonded/dvdl.dat" "AA-AB/complex/recharge/dvdl.dat" )
                    FEP::FOR
  ...
  (COMMON-LISP:WITH-OPEN-FILE (FEP::FOUT "AA-AB/complex/side-analysis.dat" :DIRECTION :OUTPUT)
